...
const MAP_CONFIGS: Dictionary = {
	...
	"swamp": {
		...
		"description": "Болотный ядовитый воздух замедляет механизмы (-15% скор. атаки). Уровень башен ограничен 3-м уровнем. 10 каток.",
		"unlock_req": {"type": "stars", "map": "valley", "count": 2},
		"modifiers": ["☣️ Ядовитый воздух: -15% скор. атаки", "🔀 3 маршрута", "🔒 Макс. ур. башен: 3", "📜 Доступны военные контракты"],
		"path_branches": 3,
		"max_waves": 15,
	...
	"caves": {
		...
		"description": "Глубокие подземные туннели. Открыт 4-й уровень башен (Мастерские формы)! 12 каток.",
		"unlock_req": {"type": "completed_maps", "count": 2},
		"modifiers": ["🌑 Глубокая тьма: -40% обзор", "🔀 2 маршрута", "🔓 Доступен 4-й уровень башен"],
		"path_branches": 2,
		"max_waves": 15,
	...
	"frost_peak": {
		...
		"description": "Ледяные тропы ускоряют врагов (+20% скор.). Мастерские формы башен (Ур. 4). 12 каток.",
		"unlock_req": {"type": "both_maps", "maps": ["swamp", "caves"]},
		"modifiers": ["⚡ Скользкий лед: +20% скор. монстров", "🚫 Ловушки отключены", "🔓 Доступен 4-й уровень башен"],
		"path_branches": 2,
		"max_waves": 20,
	...
	"besieged_citadel": {
		...
		"description": "Финальная битва за столицу королевства. 15 грандиозных каток с атаками с 4 фронтов! Открыта ЭВОЛЮЦИЯ (5-й уровень башен с выбором ветки)!",
		"unlock_req": {"type": "map_completed", "map": "frost_peak"},
		"modifiers": ["🛡️ Осада столицы", "🔀 4 фронта атаки", "👑 Открыт 5-й уровень: Эволюция A/B!"],
		"path_branches": 4,
		"max_waves": 25,
